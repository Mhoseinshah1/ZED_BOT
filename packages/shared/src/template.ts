// =============================================================================
// Pure `{variable}` template rendering. Dependency-free so the bot (message
// templates / button texts) and the worker (automated-notification delivery)
// share ONE implementation - a notification rendered by the worker is byte-for-
// byte identical to the same template rendered by the bot.
// =============================================================================
