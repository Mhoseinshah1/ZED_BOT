...
// consumes with its grammY Api: fulfil a wallet-paid order, run post-settle
// notices for a gateway payment, or fan a submitted receipt out to the
// admins. Enqueueing is deliberately BEST-EFFORT: the settlement has already
...
export type CommerceFollowUp =
  ...
  | { name: typeof MINIAPP_COMMERCE_JOB_NAMES.GATEWAY_FULFILL; paymentId: string }
  | { name: typeof MINIAPP_COMMERCE_JOB_NAMES.NOTIFY_RECEIPT; paymentId: string };
