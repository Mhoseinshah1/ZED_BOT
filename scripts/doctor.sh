...
check_telegram_token() {
  # Trim edge whitespace first (shared trim_env_token_value) so a whitespace-only
  # value reads as unset, exactly like the runtime resolver - a "   " token must
  # never PASS or count as configured.
  local tg bt
