...
| `terms_text` | متن قوانین | برای استفاده از ربات، ابتدا قوانین را مطالعه و تایید کنید. | — | yes | <!-- LEGACY: seeds published version 1 on upgrade; the live terms body now lives in TermsDocument -->
| `terms_page_title` | عنوان صفحه قوانین | 📜 قوانین و شرایط استفاده | — | yes |
| `terms_accepted_toast` | پیام تایید قوانین | قوانین تایید شد ✅ | — | yes |
| `terms_stale_text` | پیام نسخه قدیمی قوانین | نسخه جدیدی از قوانین منتشر شده است. لطفاً نسخه جدید را مطالعه و تایید کنید. | — | yes |
| `terms_unavailable_text` | پیام نبود متن قوانین | متن قوانین در دسترس نیست. لطفاً بعداً دوباره تلاش کنید. | — | yes |
